...
> 原文：[https://blog.csdn.net/congdianquan3478/article/details/100495058?ops_request_misc=%257B%2522request%255Fid%2522%253A%2522164835606716782092948464%2522%252C%2522scm%2522%253A%252220140713.130102334.pc%255Fblog.%2522%257D&request_id=164835606716782092948464&biz_id=0&utm_medium=distribute.pc_search_result.none-task-blog-2~blog~first_rank_ecpm_v1~rank_v31_ecpm-7-100495058.nonecase&utm_term=%E5%8C%BA%E5%9D%97%E9%93%BE%E6%95%99%E7%A8%8BFabric1.0](https://blog.csdn.net/congdianquan3478/article/details/100495058?ops_request_misc=%257B%2522request%255Fid%2522%253A%2522164835606716782092948464%2522%252C%2522scm%2522%253A%252220140713.130102334.pc%255Fblog.%2522%257D&request_id=164835606716782092948464&biz_id=0&utm_medium=distribute.pc_search_result.none-task-blog-2~blog~first_rank_ecpm_v1~rank_v31_ecpm-7-100495058.nonecase&utm_term=%E5%8C%BA%E5%9D%97%E9%93%BE%E6%95%99%E7%A8%8BFabric1.0)

**区块链教程** Fabric1.0 源代码分析配置交易-生成通道配置二。Generator 接口实现，即 bootstrapper。
...
    consortiumsGroups []*cb.ConfigGroup}func New(conf *genesisconfig.Profile) Generatorfunc (bs *bootstrapper) ChannelTemplate() configtx.Templatefunc (bs *bootstrapper) GenesisBlock() *cb.Blockfunc (bs *bootstrapper) GenesisBlockForChannel(channelID string) *cb.Block//代码在 common/configtx/tool/provisional/provisional.go
...
                ),
            )
            var anchorProtos []*pb.AnchorPeer            for _, anchorPeer := range org.AnchorPeers {
...
        }
    }
    return bs}//代码在 common/configtx/tool/provisional/provisional.go
...
        ),
    ).Block(channelID)
    return block}//代码在 common/configtx/tool/provisional/provisional.go
...
    return nil}//代码在 common/configtx/tool/configtxgen/main.go

```

genesis 更详细内容，参考： [Fabric 1.0 源代码笔记 之 configtx（配置交易） #genesis（系统通道创世区块）](https://www.imooc.com/article/genesis.md)
...
    var org *genesisconfig.Organization    for _, iorg := range conf.Application.Organizations {
        if iorg.Name == asOrg {
            org = iorg        }
    }
...
来自 “ ITPUB 博客 ” ，链接：http://blog.itpub.net/31557831/viewspace-2218054/，如需转载，请注明出处，否则将追究法律责任。

转载于:http://blog.itpub.net/31557831/viewspace-2218054/